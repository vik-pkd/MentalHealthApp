...
type GameScreenProps = NativeStackScreenProps<GameStackParamList, 'Tower'>;

const Tower = ({ navigation }: GameScreenProps) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <WebView
                source={{ uri: 'file:///android_asset/games/tower/index.html' }}
