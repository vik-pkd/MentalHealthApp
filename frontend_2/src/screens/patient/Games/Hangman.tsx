...
type GameScreenProps = NativeStackScreenProps<GameStackParamList, 'Hangman'>;

const Hangman = ({ navigation }: GameScreenProps) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <WebView
                source={{ uri: 'file:///android_asset/games/hangman/index.html' }}
