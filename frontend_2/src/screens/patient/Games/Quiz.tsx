...
type GameScreenProps = NativeStackScreenProps<GameStackParamList, 'Quiz'>;

const Quiz = ({ navigation }: GameScreenProps) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <WebView
                source={{ uri: 'file:///android_asset/games/quiz/index.html' }}
