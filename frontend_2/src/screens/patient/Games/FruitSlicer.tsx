...
type GameScreenProps = NativeStackScreenProps<GameStackParamList, 'FruitSlicer'>;

const FruitSlicer = ({ navigation }: GameScreenProps) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <WebView
                source={{ uri: 'file:///android_asset/games/fruit_slicer/index.html' }}
