...
type GameScreenProps = NativeStackScreenProps<GameStackParamList, 'RockPaperScissors'>;

const RockPaperScissors = ({ navigation }: GameScreenProps) => {
    ...
    const handleMessage = (event: any) => {
        ...
        if (data.type) {
            ...
            updateUserPoints(data.points, 'Casual');
        }
    };
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <WebView
                source={{ uri: 'file:///android_asset/games/rock_paper_scissors/index.html' }}
