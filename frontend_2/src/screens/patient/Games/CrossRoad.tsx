...
type GameScreenProps = NativeStackScreenProps<GameStackParamList, 'CrossRoad'>;

const CrossRoad = ({ navigation }: GameScreenProps) => {
    ...
    const handleMessage = (event: any) => {
        ...
        if (data.type) {
            ...
            updateUserPoints(data.points, ' Coordination');
        }
    };
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <WebView
                source={{ uri: 'file:///android_asset/games/crossroad/index.html' }}
