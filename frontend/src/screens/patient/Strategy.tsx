...
const cards = [
    { id: '1', title: 'Tic Tac Toe', description: "Boosts strategic thinking, pattern recognition, and spatial awareness. Enhances decision-making by teaching players to anticipate and block opponent moves.", imageUrl: require('../../tic-tac-toe-main.png'), navigate: 'TicTacToe' as keyof GameStackParamList },
