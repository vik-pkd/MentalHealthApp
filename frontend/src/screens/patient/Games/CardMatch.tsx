...
type GameScreenProps = NativeStackScreenProps<GameStackParamList, 'CardMatch'>;

const CardMatch = ({ navigation }: GameScreenProps) => {
    ...
    const handleMessage = (event: any) => {
        ...
        if (data.type) {
            ...
            updateUserPoints(data.points, 'Memory');
        }
    };
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <WebView
                source={{ uri: 'file:///android_asset/games/card_matching/index.html' }}
