...
type GameScreenProps = NativeStackScreenProps<GameStackParamList, 'TwoZero'>;

const TwoZero = ({ navigation }: GameScreenProps) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <WebView
                source={{ uri: 'file:///android_asset/games/2048/index.html' }}
