...
type GameScreenProps = NativeStackScreenProps<GameStackParamList, 'PingPong'>;

const PingPong = ({ navigation }: GameScreenProps) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <WebView
                source={{ uri: 'file:///android_asset/games/ping_pong/index.html' }}
