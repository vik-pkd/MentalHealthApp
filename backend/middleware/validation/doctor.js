...
exports.validateDoctorSignUp = [
    check('name').trim().not().isEmpty().withMessage('Non-empty name is required!').not().isAlpha().withMessage('Must be a valid name!').isLength({ min: 3, max: 30 }).withMessage('Name must be within 3 to 30 characters!'),
